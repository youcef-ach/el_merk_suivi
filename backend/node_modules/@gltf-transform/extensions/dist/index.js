import { Accessor, AnimationChannel, AnimationSampler, BufferUtils, Extension, ExtensionProperty, GLB_BUFFER, ImageUtils, MathUtils, Primitive, PropertyType, RefList, RefMap, RefSet, Root, TextureChannel, TextureInfo, WriterContext, getBounds } from "@gltf-transform/core";
import { KHR_DF_MODEL_ETC1S, KHR_DF_MODEL_UASTC, KHR_SUPERCOMPRESSION_NONE, VK_FORMAT_ASTC_4x4_SFLOAT_BLOCK_EXT, VK_FORMAT_E5B9G9R9_UFLOAT_PACK32, VK_FORMAT_UNDEFINED, read } from "ktx-parse";
...
const KHR_ACCESSOR_FLOAT16 = "KHR_accessor_float16";
const KHR_ACCESSOR_FLOAT64 = "KHR_accessor_float64";
...
const KHR_MESH_PRIMITIVE_RESTART = "KHR_mesh_primitive_restart";
const KHR_MESH_QUANTIZATION = "KHR_mesh_quantization";
const KHR_NODE_VISIBILITY = "KHR_node_visibility";
const KHR_TEXTURE_BASISU = "KHR_texture_basisu";
const KHR_TEXTURE_TRANSFORM = "KHR_texture_transform";
const KHR_XMP_JSON_LD = "KHR_xmp_json_ld";
//#endregion
//#region src/ext-mesh-features/feature-id.ts
/**
...
//#endregion
//#region src/ext-mesh-features/feature-id-texture.ts
/**
...
//#endregion
//#region src/ext-mesh-features/features.ts
/**
...
//#endregion
//#region src/ext-mesh-features/mesh-features.ts
const NAME$2 = EXT_MESH_FEATURES;
/******************************************************************************
* Implementation.
*/
/**
...
//#endregion
//#region src/ext-mesh-gpu-instancing/instanced-mesh.ts
...
//#endregion
//#region src/ext-mesh-gpu-instancing/mesh-gpu-instancing.ts
/**
...
//#endregion
//#region src/ext-meshopt-compression/constants.ts
let EncoderMethod$1 = /* @__PURE__ */ function(EncoderMethod) {
	EncoderMethod["QUANTIZE"] = "quantize";
	EncoderMethod["FILTER"] = "filter";
	return EncoderMethod;
}({});
//#endregion
//#region src/ext-meshopt-compression/decoder.ts
/**
...
//#endregion
//#region src/ext-meshopt-compression/encoder.ts
...
//#endregion
//#region src/ext-meshopt-compression/meshopt-compression.ts
const DEFAULT_ENCODER_OPTIONS$1 = { method: "quantize" };
/**
...
//#endregion
//#region src/ext-structural-metadata/metadata.ts
/******************************************************************************
...
//#endregion
//#region src/ext-structural-metadata/structural-metadata.ts
/******************************************************************************
* Implementation.
*/
/**
...
//#endregion
//#region src/ext-texture-avif/texture-avif.ts
...
//#endregion
//#region src/ext-texture-webp/texture-webp.ts
...
//#endregion
//#region src/khr-accessor-float16/accessor-float16.ts
const NAME$1 = KHR_ACCESSOR_FLOAT16;
/**
...
//#endregion
//#region src/khr-accessor-float64/accessor-float64.ts
...
//#endregion
//#region src/khr-draco-mesh-compression/decoder.ts
let decoderModule;
let COMPONENT_ARRAY;
let DATA_TYPE;
...
//#endregion
//#region src/khr-draco-mesh-compression/encoder.ts
let encoderModule;
let EncoderMethod = /* @__PURE__ */ function(EncoderMethod) {
...
function addAttribute(builder, componentType, mesh, attribute, count, itemSize, array) {
	switch (componentType) {
		case Accessor.ComponentType.UNSIGNED_BYTE: return builder.AddUInt8Attribute(mesh, attribute, count, itemSize, array);
		case Accessor.ComponentType.BYTE: return builder.AddInt8Attribute(mesh, attribute, count, itemSize, array);
		case Accessor.ComponentType.UNSIGNED_SHORT: return builder.AddUInt16Attribute(mesh, attribute, count, itemSize, array);
		case Accessor.ComponentType.SHORT: return builder.AddInt16Attribute(mesh, attribute, count, itemSize, array);
		case Accessor.ComponentType.UNSIGNED_INT: return builder.AddUInt32Attribute(mesh, attribute, count, itemSize, array);
		case Accessor.ComponentType.FLOAT: return builder.AddFloatAttribute(mesh, attribute, count, itemSize, array);
		default: throw new Error(`Unexpected component type, "${componentType}".`);
	}
}
var EncodingError = class extends Error {};
//#endregion
//#region src/khr-draco-mesh-compression/draco-mesh-compression.ts
/**
...
//#endregion
//#region src/khr-lights-punctual/light.ts
/**
* Defines a light attached to a {@link Node}. See {@link KHRLightsPunctual}.
*/
var Light = class Light extends ExtensionProperty {
...
//#endregion
//#region src/khr-lights-punctual/lights-punctual.ts
/**
...
var KHRLightsPunctual = class extends Extension {
	...
	write(context) {
		...
		for (const property of this.properties) {
			...
			const lightDef = context.createPropertyDef(property);
...
//#endregion
//#region src/khr-materials-anisotropy/anisotropy.ts
const { R: R$7, G: G$7, B: B$5 } = TextureChannel;
/**
...
//#endregion
//#region src/khr-materials-anisotropy/materials-anisotropy.ts
/**
	...
	preread(context) {
		...
		materialDefs.forEach((materialDef, materialIndex) => {
			if (materialDef.extensions && materialDef.extensions["KHR_materials_anisotropy"]) {
				...
				if (anisotropyDef.extras) anisotropy.setExtras(anisotropyDef.extras);
	...
	prewrite(context) {
		...
		this.document.getRoot().listMaterials().forEach((material) => {
			...
			if (anisotropy) {
				...
				const anisotropyDef = context.createPropertyDef(anisotropy);
...
//#endregion
//#region src/khr-materials-clearcoat/clearcoat.ts
const { R: R$6, G: G$6, B: B$4 } = TextureChannel;
/**
...
//#endregion
//#region src/khr-materials-clearcoat/materials-clearcoat.ts
/**
	...
	preread(context) {
		...
		materialDefs.forEach((materialDef, materialIndex) => {
			if (materialDef.extensions && materialDef.extensions["KHR_materials_clearcoat"]) {
				...
				if (clearcoatDef.extras) clearcoat.setExtras(clearcoatDef.extras);
	...
	prewrite(context) {
		...
		this.document.getRoot().listMaterials().forEach((material) => {
			...
			if (clearcoat) {
				const materialIndex = context.materialIndexMap.get(material);
				const materialDef = jsonDoc.json.materials[materialIndex];
				const clearcoatDef = context.createPropertyDef(clearcoat);
				materialDef.extensions = materialDef.extensions || {};
...
//#endregion
//#region src/khr-materials-diffuse-transmission/diffuse-transmission.ts
const { R: R$5, G: G$5, B: B$3, A: A$3 } = TextureChannel;
/**
...
//#endregion
//#region src/khr-materials-diffuse-transmission/materials-diffuse-transmission.ts
/**
...
var KHRMaterialsDiffuseTransmission = class extends Extension {
	...
	read(context) {
		...
		materialDefs.forEach((materialDef, materialIndex) => {
			if (materialDef.extensions && materialDef.extensions["KHR_materials_diffuse_transmission"]) {
				...
				if (transmissionDef.extras) transmission.setExtras(transmissionDef.extras);
	...
	write(context) {
		...
		for (const material of this.document.getRoot().listMaterials()) {
			...
			const materialIndex = context.materialIndexMap.get(material);
			const materialDef = jsonDoc.json.materials[materialIndex];
			const transmissionDef = context.createPropertyDef(transmission);
			materialDef.extensions = materialDef.extensions || {};
...
//#endregion
//#region src/khr-materials-dispersion/dispersion.ts
/**
...
//#endregion
//#region src/khr-materials-dispersion/materials-dispersion.ts
/**
	...
	preread(context) {
		(context.jsonDoc.json.materials || []).forEach((materialDef, materialIndex) => {
			if (materialDef.extensions && materialDef.extensions["KHR_materials_dispersion"]) {
				...
				if (dispersionDef.extras) dispersion.setExtras(dispersionDef.extras);
	...
	prewrite(context) {
		...
		this.document.getRoot().listMaterials().forEach((material) => {
			...
			if (dispersion) {
				const materialIndex = context.materialIndexMap.get(material);
				const materialDef = jsonDoc.json.materials[materialIndex];
				const dispersionDef = context.createPropertyDef(dispersion);
				materialDef.extensions = materialDef.extensions || {};
...
//#endregion
//#region src/khr-materials-emissive-strength/emissive-strength.ts
/**
...
//#endregion
//#region src/khr-materials-emissive-strength/materials-emissive-strength.ts
/**
	...
	preread(context) {
		(context.jsonDoc.json.materials || []).forEach((materialDef, materialIndex) => {
			if (materialDef.extensions && materialDef.extensions["KHR_materials_emissive_strength"]) {
				...
				if (emissiveStrengthDef.extras) emissiveStrength.setExtras(emissiveStrengthDef.extras);
	...
	prewrite(context) {
		...
		this.document.getRoot().listMaterials().forEach((material) => {
			...
			if (emissiveStrength) {
				const materialIndex = context.materialIndexMap.get(material);
				const materialDef = jsonDoc.json.materials[materialIndex];
				const emissiveStrengthDef = context.createPropertyDef(emissiveStrength);
				materialDef.extensions = materialDef.extensions || {};
...
//#endregion
//#region src/khr-materials-ior/ior.ts
/**
...
//#endregion
//#region src/khr-materials-ior/materials-ior.ts
/**
	...
	preread(context) {
		(context.jsonDoc.json.materials || []).forEach((materialDef, materialIndex) => {
			if (materialDef.extensions && materialDef.extensions["KHR_materials_ior"]) {
				...
				if (iorDef.extras) ior.setExtras(iorDef.extras);
	...
	prewrite(context) {
		...
		this.document.getRoot().listMaterials().forEach((material) => {
			...
			if (ior) {
				const materialIndex = context.materialIndexMap.get(material);
				const materialDef = jsonDoc.json.materials[materialIndex];
				const iorDef = context.createPropertyDef(ior);
				materialDef.extensions = materialDef.extensions || {};
...
//#endregion
//#region src/khr-materials-iridescence/iridescence.ts
const { R: R$4, G: G$4 } = TextureChannel;
/**
...
//#endregion
//#region src/khr-materials-iridescence/materials-iridescence.ts
/**
	...
	preread(context) {
		...
		materialDefs.forEach((materialDef, materialIndex) => {
			if (materialDef.extensions && materialDef.extensions["KHR_materials_iridescence"]) {
				...
				if (iridescenceDef.extras) iridescence.setExtras(iridescenceDef.extras);
	...
	prewrite(context) {
		...
		this.document.getRoot().listMaterials().forEach((material) => {
			...
			if (iridescence) {
				const materialIndex = context.materialIndexMap.get(material);
				const materialDef = jsonDoc.json.materials[materialIndex];
				const iridescenceDef = context.createPropertyDef(iridescence);
				materialDef.extensions = materialDef.extensions || {};
...
//#endregion
//#region src/khr-materials-pbr-specular-glossiness/pbr-specular-glossiness.ts
const { R: R$3, G: G$3, B: B$2, A: A$2 } = TextureChannel;
/**
...
//#endregion
//#region src/khr-materials-pbr-specular-glossiness/materials-pbr-specular-glossiness.ts
/**
	...
	preread(context) {
		...
		materialDefs.forEach((materialDef, materialIndex) => {
			if (materialDef.extensions && materialDef.extensions["KHR_materials_pbrSpecularGlossiness"]) {
				...
				if (specGlossDef.extras) specGloss.setExtras(specGlossDef.extras);
	...
	prewrite(context) {
		...
		this.document.getRoot().listMaterials().forEach((material) => {
			...
			if (specGloss) {
				const materialIndex = context.materialIndexMap.get(material);
				const materialDef = jsonDoc.json.materials[materialIndex];
				const specGlossDef = context.createPropertyDef(specGloss);
				materialDef.extensions = materialDef.extensions || {};
...
//#endregion
//#region src/khr-materials-sheen/sheen.ts
const { R: R$2, G: G$2, B: B$1, A: A$1 } = TextureChannel;
/**
...
//#endregion
//#region src/khr-materials-sheen/materials-sheen.ts
/**
	...
	preread(context) {
		...
		materialDefs.forEach((materialDef, materialIndex) => {
			if (materialDef.extensions && materialDef.extensions["KHR_materials_sheen"]) {
				...
				if (sheenDef.extras) sheen.setExtras(sheenDef.extras);
	...
	prewrite(context) {
		...
		this.document.getRoot().listMaterials().forEach((material) => {
			...
			if (sheen) {
				const materialIndex = context.materialIndexMap.get(material);
				const materialDef = jsonDoc.json.materials[materialIndex];
				const sheenDef = context.createPropertyDef(sheen);
				materialDef.extensions = materialDef.extensions || {};
...
//#endregion
//#region src/khr-materials-specular/specular.ts
const { R: R$1, G: G$1, B, A } = TextureChannel;
/**
...
//#endregion
//#region src/khr-materials-specular/materials-specular.ts
/**
	...
	preread(context) {
		...
		materialDefs.forEach((materialDef, materialIndex) => {
			if (materialDef.extensions && materialDef.extensions["KHR_materials_specular"]) {
				...
				if (specularDef.extras) specular.setExtras(specularDef.extras);
	...
	prewrite(context) {
		...
		this.document.getRoot().listMaterials().forEach((material) => {
			...
			if (specular) {
				const materialIndex = context.materialIndexMap.get(material);
				const materialDef = jsonDoc.json.materials[materialIndex];
				const specularDef = context.createPropertyDef(specular);
				materialDef.extensions = materialDef.extensions || {};
...
//#endregion
//#region src/khr-materials-transmission/transmission.ts
...
//#endregion
//#region src/khr-materials-transmission/materials-transmission.ts
/**
...
//#endregion
//#region src/khr-materials-unlit/unlit.ts
/**
...
//#endregion
//#region src/khr-materials-unlit/materials-unlit.ts
/**
...
//#endregion
//#region src/khr-materials-variants/mapping.ts
/**
...
//#endregion
//#region src/khr-materials-variants/mapping-list.ts
/**
...
//#endregion
//#region src/khr-materials-variants/variant.ts
/**
...
//#endregion
//#region src/khr-materials-variants/materials-variants.ts
/**
...
//#endregion
//#region src/khr-materials-volume/volume.ts
...
//#endregion
//#region src/khr-materials-volume/materials-volume.ts
/**
	...
	preread(context) {
		...
		materialDefs.forEach((materialDef, materialIndex) => {
			if (materialDef.extensions && materialDef.extensions["KHR_materials_volume"]) {
				...
				if (volumeDef.extras) volume.setExtras(volumeDef.extras);
	...
	prewrite(context) {
		...
		this.document.getRoot().listMaterials().forEach((material) => {
			...
			if (volume) {
				const materialIndex = context.materialIndexMap.get(material);
				const materialDef = jsonDoc.json.materials[materialIndex];
				const volumeDef = context.createPropertyDef(volume);
				materialDef.extensions = materialDef.extensions || {};
...
//#endregion
//#region src/khr-mesh-primitive-restart/mesh-primitive-restart.ts
/**
...
//#endregion
//#region src/khr-mesh-quantization/mesh-quantization.ts
/**
...
//#endregion
//#region src/khr-node-visibility/visibility.ts
/**
...
//#endregion
//#region src/khr-node-visibility/node-visibility.ts
/**
...
//#endregion
//#region src/khr-texture-basisu/texture-basisu.ts
...
var KTX2ImageUtils = class {
	...
	getChannels(array) {
		...
		if (isUniversal(container)) switch (dfd.colorModel) {
			case KHR_DF_MODEL_ETC1S: return dfd.samples.length === 2 && (dfd.samples[1].channelType & 15) === 15 ? 4 : 3;
			case KHR_DF_MODEL_UASTC: return (dfd.samples[0].channelType & 15) === 3 ? 4 : 3;
			default: throw new Error(`Unexpected KTX2 colorModel, "${dfd.colorModel}".`);
		}
...
//#endregion
//#region src/khr-texture-transform/transform.ts
/**
...
//#endregion
//#region src/khr-texture-transform/texture-transform.ts
/**
...
//#endregion
//#region src/khr-xmp-json-ld/packet.ts
const PARENT_TYPES = [
	PropertyType.ROOT,
	PropertyType.SCENE,
	PropertyType.NODE,
...
//#endregion
//#region src/khr-xmp-json-ld/xmp.ts
/**
